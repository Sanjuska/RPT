...
public class EditingCell extends TableCell<TableVariants, String> {
    ...
    private List<TableColumn<VariantsController, ?>> getLeaves(TableColumn<VariantsController, ?> root) {
        List<TableColumn<VariantsController, ?>> columns = new ArrayList<>();
        if (root.getColumns().isEmpty()) {
            ...
            for (TableColumn<VariantsController, ?> column : root.getColumns()) {
                columns.addAll(getLeaves(column));
            }
            return columns;
        }
