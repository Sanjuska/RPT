...
public class EditingCell extends TableCell<TableVariants, String> {
    ...
    private List<TableColumn<CyclePlansController, ?>> getLeaves(TableColumn<CyclePlansController, ?> root) {
        List<TableColumn<CyclePlansController, ?>> columns = new ArrayList<>();
        if (root.getColumns().isEmpty()) {
            ...
            for (TableColumn<CyclePlansController, ?> column : root.getColumns()) {
                columns.addAll(getLeaves(column));
            }
            return columns;
        }
